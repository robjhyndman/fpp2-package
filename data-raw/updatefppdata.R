...
ausproduction <- readxl::read_excel("data-raw/830101.xls", sheet="Data1",
...
auscafe <- ts(readxl::read_excel("data-raw/850101.xls", sheet="Data1",
...
departures <- ts(readxl::read_excel("data-raw/340102.xls", sheet="Data1",
                                 skip=9, col_names=TRUE),
